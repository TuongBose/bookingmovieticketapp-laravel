                        ...
                        <div class="cinestar-movie-card position-relative overflow-hidden rounded-3 shadow-lg h-100">
                            ...
                            <a href="{{ url('/' . $movie['id']) }}" class="text-decoration-none d-block">
                                ...
                                <div class="poster position-relative">
                                    <img src="{{ $movie['posterurl'] }}" class="w-100 h-100 rounded-3"
                                    ...
                                    <div
                                        class="play-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-dark bg-opacity-70 opacity-0 transition">
                                ...
                                <div class="info p-3 text-center">
                                    ...
                                    <a href="{{ url('/' . $movie['id']) }}"
                                        class="btn-datve btn btn-sm fw-bold rounded-pill px-4">
                                        ĐẶT VÉ NGAY
                                    </a>
                                </div>
